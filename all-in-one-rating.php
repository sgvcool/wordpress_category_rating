...
function AIO_Rating($ratings_post_id = 0, $page_type = 'post'){
	if($page_type == '') {
		$page_type = 'post';
	}
	...
	wp_enqueue_script('wp-all_in_one_post_ratings_js', plugins_url('all-in-one-post-ratings-js.js',__FILE__),'','1.0.5', false);
