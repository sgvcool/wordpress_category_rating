			...
			if(!empty($Allow_To_Rate)){
				...
				if(!empty($user_Rating_Restriction)){
					...
					if($_POST['page_type'] == "category") {
						...
						$aio_rating_count = get_term_meta($post_ID,'aio_rating_count',true);
						$aio_rating_count = ($aio_rating_count+1);
						$aio_total_rating = get_term_meta($post_ID,'aio_total_rating',true);
						...
						update_term_meta($post_ID, 'aio_rating_count', $aio_rating_count);
						update_term_meta($post_ID, 'aio_total_rating', $aio_total_rating);
						update_term_meta($post_ID, 'aio_average_rating', $aio_average_post_rating);
 ...
 */
function aoi_post_rating_result($ratings_post_id, $total_rating, $rating_none_img, $rating_full_img, $rating_avg_img, $rating_hover_img, $page_type){
	//echo $page_type;
	if($page_type =="category") {
		$total_no_of_avg = get_term_meta($ratings_post_id, 'aio_average_rating', true);
		$AIO_RATINGS_SCORE = get_term_meta($ratings_post_id, 'aio_total_rating', true);
		$AIO_TOTAL_NO_RAT = get_term_meta($ratings_post_id, 'aio_rating_count', true);	
					...
					if(!empty($avg_loop_half_rating)) {
						if($i <= $total_no_of_avg_loop ){
							if($i == $avg_loop_half_rating ){
								$AIO_RATING_IMAGES .= '<img id="'.$ratings_post_id.'_'.$i.'" src="'.$rating_avg_img.'"  alt="rating_'.$i.'" data-rat="'.$i.'" onclick="give_rate($(this),'.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseover="aio_rating_hover('.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseout="aio_rating_none('.$ratings_post_id.', '.$i.', '.$page_type.');" data-img-name="avg_rating" >';
								
							}else{							
								$AIO_RATING_IMAGES .= '<img id="'.$ratings_post_id.'_'.$i.'" src="'.$rating_full_img.'"  alt="rating_'.$i.'" data-rat="'.$i.'" onclick="give_rate($(this),'.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseover="aio_rating_hover('.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseout="aio_rating_none('.$ratings_post_id.', '.$i.', '.$page_type.');" data-img-name="rating_full" >';
							}
						}else{						
							$AIO_RATING_IMAGES .= '<img id="'.$ratings_post_id.'_'.$i.'" src="'.$rating_none_img.'"  alt="rating_'.$i.'" data-rat="'.$i.'" onclick="give_rate($(this),'.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseover="aio_rating_hover('.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseout="aio_rating_none('.$ratings_post_id.', '.$i.', '.$page_type.');" data-img-name="rating_none" >';
						}
					}else{
						if($i <= $total_no_of_avg_loop ){
							$AIO_RATING_IMAGES .= '<img id="'.$ratings_post_id.'_'.$i.'" src="'.$rating_full_img.'"  alt="rating_'.$i.'" data-rat="'.$i.'" onclick="give_rate($(this),'.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseover="aio_rating_hover('.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseout="aio_rating_none('.$ratings_post_id.', '.$i.', '.$page_type.');"  data-img-name="rating_full">';
...
function  aoi_post_rating_none($ratings_post_id, $total_rating, $rating_none_img, $rating_full_img, $rating_avg_img, $rating_hover_img, $page_type){
	$page_type = "'".$page_type."'";
	//echo $page_type;
	...
	for($i=1; $i <= $total_rating; $i++){
		$AIO_RATING_IMAGES .= '<img id="'.$ratings_post_id.'_'.$i.'" src="'.$rating_none_img.'"  alt="rating_'.$i.'" data-rat="'.$i.'" onclick="give_rate($(this),'.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseover="aio_rating_hover('.$ratings_post_id.', '.$i.', '.$page_type.');" onmouseout="aio_rating_none('.$ratings_post_id.', '.$i.', '.$page_type.');">';
	}
