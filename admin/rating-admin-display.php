...
<div class="wrap">
	...
	<form method="post" action="">		
		...
		<h4>Do not update plugin, please!!!</h4>
		...
		<div id="rating_option_wrapper">
			...
			<div class="wrapper-left-area">
				...
				<tr>
					...
					<td><input type="text" name="no_of_rating" value="<?php echo $total_rating;?>" class="num-error-val" maxlength="5" onkeyup="this.value = minmax(this.value, 1, 100)"> <span id="num-error-msg"></span></td>
				</tr>
				<tr>
